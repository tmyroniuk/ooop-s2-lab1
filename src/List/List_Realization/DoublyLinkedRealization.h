/**
 * @file LinkedRealization.h
 * @author tmyroniuk
 * @date 13.10.2019
 * @brief Contains declaration of LinkedRealization class.
 */

#ifndef LISTS_LinkedRealization_H
#define LISTS_LinkedRealization_H
 ...
 */
template<typename T>
class DoublyLinkedRealization : public ListRealization<T> {
public:
    /**
     ...
     * in the list.
     */
    virtual ~DoublyLinkedRealization();
...
#include "DoublyLinkedRealization.inl.h"

#endif //LISTS_LinkedRealization_H
